...
final class DecodeHandler extends Handler {
    ...
    DecodeHandler(IBarCode iBarCode, Map<DecodeHintType, Object> hints) {
    ...
    private void decode(byte[] data, int width, int height) {
        ...
        PlanarYUVLuminanceSource source = iBarCode.getCameraManager().buildLuminanceSource(data, width, height);
        if (source != null) {
        ...
        Handler handler = iBarCode.getHandler();
        if (rawResult != null) {
